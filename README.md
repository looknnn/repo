...
##### sudo apt install
 ...
 ` debian:: nvidia-detect nvidia-smi bash-completion nvidia-cuda-dev gnome-shell-extension-dashtodock fcitx-googlepinyin fcitx-dbus-status gnome-shell-extension-desktop-icons nvidia-cg-dev fcitx-table-wubi `
